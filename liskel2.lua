...
function f.loadfile(file)
  return load(f.readfile(file),'='..file)
end
...
function console.history.PrintAll() -- reprint viewport
...
function console.history.Update() -- update viewport
...
function console.input.Print() -- print input
